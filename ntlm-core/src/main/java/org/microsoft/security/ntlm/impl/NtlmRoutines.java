...
*/
    ...
    public static byte[] mac(int negotiateFlags, int seqNum, byte[] signingKey, Cipher sealingKey, byte[] randomPad, byte[] message) {
...
EndDefine
     ...
     */
    public static byte[] macWithoutExtendedSessionSecurity(int seqNumIn, byte[] randomPadIn, Cipher sealingKey, byte[] message) {
